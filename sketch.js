...
function setup() {
	...
	block9 = new Box2(360, 300, 30, 40);
	block10= new Box2(390, 300, 30, 40);
	block11= new Box2(420, 300, 30, 40);
	block12= new Box2(450, 300, 30, 40);
	block13= new Box2(480, 300, 30, 40);
	block14= new Box2(510, 300, 30, 40);
 
	block15= new Box3(390, 270, 30, 40);
	block16= new Box3(420, 270, 30, 40);
	block17= new Box3(450, 270, 30, 40);
	block18= new Box3(480, 270, 30, 40);	

	block19= new Box4(420, 240, 30, 40);
	block20= new Box4(450, 240, 30, 40);

	Block21= new Box5(435, 210, 30, 40);
	...
	block29 = new Box4(710, 450, 30, 40);
	block30 = new Box4(740, 450, 30, 40);
 	block31 = new Box4(770, 450, 30, 40);
	block32 = new Box4(800, 450, 30, 40);
	block33 = new Box4(830, 450, 30, 40);
	block34 = new Box4(860, 450, 30, 40);
	
	block35 = new Box3(740, 420, 30, 40);
 	block36 = new Box3(770, 420, 30, 40);
	block37 = new Box3(800, 420, 30, 40);
	block38 = new Box3(830, 420, 30, 40);

	block39 = new Box2(770, 390, 30, 40);
	block40 = new Box2(800, 390, 30, 40);

	block41 = new Box5(785, 350, 30, 40); 
